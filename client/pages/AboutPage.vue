<template>
  <div id='about'>
    Thank you for visiting the Blockchain Chess Lounge, a peer-to-peer chess application that settles on the Ethereum blockchain.
    ...
    <div class='container'>
      <button @click='() => this.$router.push("/lobby")'>Play!</button>
    </div>
  </div>
</template>
